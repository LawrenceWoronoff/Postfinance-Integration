...
$massage = DB::queryFirstRow("SELECT * FROM prestations WHERE ID=%i", $id);
...
<form method="POST" action="bd_modi_massage.php">
...
<div class="form-group">
<label for="exampleInputEmail1">Nb personnes</label>
<input  name="personnes" type="text" class="form-control" id="personnes" value="<?php echo $personnes; ?>">
</div>
<div class="form-group">
