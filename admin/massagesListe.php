...
<button type="submit" class="btn btn-success">Enregistrer</button></div>
	...
	<div class="row">
		   ...
		   <?php
    echo "<tr><th>Massage</th><th>Emplacement</th><th>Action</th></tr>";
...
$massages = DB::query("SELECT * FROM prestations");
        ...
        <button id='sautPlus' type='button' class='btn btn-success' aria-label='Left Align' onclick=\"document.location.href='packsListe.php?id=" . $massage['ID'] . "'\">
