...
<button type="submit" class="btn btn-success">Enregistrer</button></div>
	...
	<div class="row">
		   ...
		   <?php
    echo "<tr><th>Date</th><th>Auteur</th><th>Témoignage</th><th>Action</th></tr>";
...
$temoignages = DB::query("SELECT * FROM temoignages");
    ...
    <button id='sautPlus' type='button' class='btn btn-info' aria-label='Left Align' onclick=\"document.location.href='modi_temoignage.php?id=" . $massage['ID'] . "'\">
					<span class='glyphicon glyphicon-edit' ></span>
					Modifier ce texte
				</button>

    <button id='sautPlus' type='button' class='btn btn-danger' aria-label='Left Align' onclick=\"document.location.href='bd_delete_temoignage.php?id=" . $massage['ID'] . "'\">
